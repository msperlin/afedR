...
**02. Using `BatchGetSymbols::GetSP500Stocks` function, select four random stocks and download stock prices for the previous 3 years. Estimate an ARIMA model (1,0,1) for each stock and report the result on the R screen with `texreg::screenreg` function.**
