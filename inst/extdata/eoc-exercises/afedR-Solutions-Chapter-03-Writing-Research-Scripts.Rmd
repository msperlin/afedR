...
# Chapter 03: Writing Research Scripts

Here you'll find the solutions to the exercises in the end of chapter 03 of "Analyzing Financial Data with R". 
...
1) Importing 01: Import all data regarding personal income and budget, investments in fixed income and historical prices of home in desired locations;

2) Cleaning 01: Clean the data for outliers and bad cases (NA);
