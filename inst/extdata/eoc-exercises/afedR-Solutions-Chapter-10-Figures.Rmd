...
**01. Download Facebook (FB) stock data  with the `BatchGetSymbols` package for the past 500 days. Display the line graph of the adjusted prices over time using the `ggplot2::ggplot` function. Make sure that:**
...
**05. Modify the previous chart theme to a grey scale for both the chart area and the line colors.**
...
**08. Go to the [Kaggle data website](https://www.kaggle.com/datasets)^[https://www.kaggle.com/datasets] and chose a particular dataset for your analysis. It need not be related to economics or finance. Fell free to make a decision based on your own interests. After downloading the data, create a visual analysis of the data. Fell free to try out one or more plots of interest. **
