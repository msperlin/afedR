...
**Use `Rprof` and `profvis` to identify the time bottleneck of the code. Which line number is taking more time?**
...
04. Use package `memoise` to create a memorized version of `Quandl::Quandl`. Use the new function to import data for the Consumer Price Index of the United States (code `'FRED/DDOE01USA086NWDB'`). How much of relative speed gain you get from the second call to the memorized version?
