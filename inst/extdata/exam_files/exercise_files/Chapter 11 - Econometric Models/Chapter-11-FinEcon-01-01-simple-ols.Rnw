...
if (lan == 'en') {
  question.1 <- paste0('Consider the financial data available in file ', basename(f.in), ' and load it in R. Notice that the actual market index is included as ticker ', mkt.ticker, '.')
