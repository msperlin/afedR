...
Use the `BatchGetSymbols` package to download the SP500 index data (`'^GSPC'`) from `r first_date` to `r last_date`. What is the sum of the `r select_n` highest positive returns on the index?
